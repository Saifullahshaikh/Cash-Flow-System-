...
#con=sqlite3.connect("I://Saify/UIT CS/Sem II/OOP Theory/Spring 2020/Mid Term/mid term/hyper mart/HyperDatabase.db")
cursor=con.cursor()
...
class Sales(Transaction):
    sale_id="S000"
    cursor.execute("CREATE TABLE IF NOT EXISTS Sales(ID TEXT, Date TEXT,Name TEXT, Price Integer,Quantity Integer, Amount INTEGER)")
    con.commit()
...
class Purchase(Transaction):
    cursor.execute("CREATE TABLE IF NOT EXISTS Purchase(ID TEXT, Date TEXT,Name TEXT,Price INTEGER,Quantity INTGER, Amount INTEGER)")
    con.commit()
    pur_id="P000"
    def assign_id(self):
        def assign():
...
class Stock(Sales, Purchase):
    cursor.execute("CREATE TABLE IF NOT EXISTS Stock(ID TEXT, Name TEXT,Quantity INTEGER,Price INTEGER, Amount INTEGER)")
    con.commit()
    stock_id="I000"
    def assign_id(self):
        def assign():
...
class HyperMart_CashFlow:
    ...
    def interface(self):
        ...
        label=Label(win,text=" HYPER MART \nDEPARTMENTAL\nSTORE",bg="blue",fg="yellow",font=("Times new roman",25,'italic','bold')).pack(fill='both')
        #image1 = Image.open("I://Saify/UIT CS/Sem II/OOP Theory/Spring 2020/Mid Term/mid term/hyper mart/win.png")
    ...
    def add_sales(self):
        ...
        style=ttk.Style()
        a=Label(sale_win,text="Enter Sales Data",bg="blue",fg='yellow',font=("Times new roman",30,"italic", 'bold')).pack(fill='both')#place(x=50,y=50)
        b=Label(sale_win,text="Select Date: ",font=("Times new roman", 14)).place(x=50,y=80)
        cal=Calendar(sale_win,font = ("Times new roman", 10, 'bold'),selectmode ='day',cursor="hand1",year =2020,month=7,day=5)
    ...
    def view_sale(self):
        ...
        Label(view_sale,text="Sales",fg="yellow",bg="blue",font=("Times new roman",30,'italic','bold')).pack(fill='both')
        ...
        a=cursor.execute("Select * from Sales")
        con.commit()
        Label(view_sale,text=('Sales Total'),bg='white',fg='blue',width=10,font=('times new roman',16,'bold')).place(x=570,y=200)
        Label(view_sale,text=(Sales.total(self)),bg='white',fg='blue',width=10,font=('times new roman',16,'bold')).place(x=570,y=230)
        for i in a:
            print(i)
    ...
    def add_pur(self):
        ...
        style=ttk.Style()
        a=Label(pur_win,text="Enter Purhase Data",fg="yellow",bg='blue',font=("Times new roman",30,"italic", 'bold')).pack(fill='both')#place(x=50,y=50)
        b=Label(pur_win,text="Select Date",font=("Times new roman", 12)).place(x=50,y=70)
        cal=Calendar(pur_win,font = ("Times new roman", 10, 'bold'),selectmode ='day',cursor="hand1",year =2020,month=7,day=5)
        cal.place(x=50,y=100)
    ...
    def view_purchase(self):
        ...
        Label(pur,text="Purchase",fg="yellow",bg="blue",font=("Times new roman",30,'italic','bold')).pack(fill='both')
        frame=Frame(pur)
        frame.place(x=10,y=100)
        tree=ttk.Treeview(frame, columns=(1,2,3,4,5,6),height=10,show="headings",style="mystyle.Treeview")
        tree.pack(side='left')
        ...
        a=cursor.execute("Select * from Purchase")
        con.commit()
        Label(pur,text='Purchase Total',bg='white',width=15,fg='blue',font=('times new roman',14,'bold')).place(x=600,y=200)
        Label(pur,text=(Purchase.total(self)),bg='white',fg='blue',width=15,font=('times new roman',14,'bold')).place(x=600,y=220)
        for i in a:
            print(i)
            tree.insert('','end',values=(i))
        def add():
        ...
        def back():
            pur.destroy()
            self.interface()
        b2=Button(pur,text="Back",fg="black",font=('times new roman',12,'bold'),command=back).place(x=450,y=350)
    def add_expense(self):
        ...
        style=ttk.Style()
        a=Label(exp_win,text="Enter Expense Data",bg="blue",fg='Yellow',font=("Times new roman",30,"italic", 'bold')).pack(fill='both')#place(x=50,y=50)
        b=Label(exp_win,text="Select Date: ",font=("Times new roman", 14)).place(x=50,y=70)
        cal=Calendar(exp_win,font = ("Times new roman", 10, 'bold'),selectmode ='day',cursor="hand1",year =2020,month=7,day=5)
        cal.place(x=50,y=100)
    ...
    def view_exp(self):
        ...
        a=cursor.execute("Select * from Expense")
        con.commit()
        Label(exp,text='Expense Total',width=15,bg='white',fg='blue',font=('times new roman',14,'bold')).place(x=500,y=200)
        Label(exp,text=(Expense.total(self)),width=15,bg='white',fg='blue',font=('times new roman',14,'bold')).place(x=500,y=220)
        for i in a:
            print(i)
            tree.insert('','end',values=(i))
        def add():
        ...
        def back():
            exp.destroy()
            self.interface()
        b2=Button(exp,text="Back",fg="black",font=('times new roman',12,'bold'),command=back).place(x=500,y=350)
    def add_stock(self):
        st_win=Tk()
        ...
        style=ttk.Style()
        a=Label(st_win,text="Enter Stock Data",bg="blue",fg='yellow',font=("Times new roman",30,"italic", 'bold')).pack(fill='both')#place(x=50,y=50)
    ...
    def view_stock(self):
        ...
        Label(stock,text="Stock",bg="blue",fg="yellow",font=("Times new roman",30,'italic', 'bold')).pack(fill='both')
        frame=Frame(stock)
        ...
        for i in a:
            print(i)
            tree.insert('','end',values=(i))
        Label(stock,text="Total Stock",bg='white',fg="blue",font=('Times new roman',14,'bold'),width=15).place(x=500,y=200)
        Label(stock,text=(Stock.total(self)),bg='white',fg="blue",font=('Times new roman',14,'bold'),width=15).place(x=500,y=220)
        def add():
            stock.destroy()
            self.add_stock()
        b1=Button(stock,text="Add",fg='green',font=('times new roman',12,'bold'), command= add).place(x=100,y=350)
        def back():
            stock.destroy()
            self.interface()
        b2=Button(stock,text="Back",fg="black",font=('times new roman',12,'bold'),command=back).place(x=500,y=350)
    ...
    def cashflow(self):
        ...
        style = ttk.Style()
        Label(win1,text='Cash-Flow Statement',bg='blue',fg='yellow',font=('Times new roman',30,'bold','italic')).pack(fill='both')
        Label(win1,text="Sale",fg='blue',font=('Times new roman',20,'bold'),width=10).place(x=50,y=80)
        Label(win1,text=(CashFlow.sale(self)),fg='blue',font=('Times new roman',20,'bold'),width=10).place(x=50,y=120)

        Label(win1,text="Purchase",fg='yellow',font=('Times new roman',20,'bold'),width=10).place(x=250,y=80)
        Label(win1,text=(CashFlow.purchase(self)),fg='yellow',font=('Times new roman',20,'bold'),width=10).place(x=250,y=120)
        
        Label(win1,text="Expense",fg='red',font=('Times new roman',20,'bold'),width=10).place(x=450,y=80)
        Label(win1,text=(CashFlow.exp_total(self)),fg='red',font=('Times new roman',20,'bold'),width=10).place(x=450,y=120)

        Label(win1,text="Stock",fg='brown',font=('Times new roman',20,'bold'),width=10).place(x=350,y=200)
        Label(win1,text=(CashFlow.total_stock(self)),fg='brown',font=('Times new roman',20,'bold'),width=10).place(x=350,y=240)
        ...
        if int(a)>0:
             ...
             messagebox.showinfo('CashFlow','Sorry! Your store is in loss, try improve your salesand lower your expenses')
        elif int(a)==0:
...
h=HyperMart_CashFlow("PIB.colony")
